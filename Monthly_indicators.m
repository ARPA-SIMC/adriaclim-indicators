...
dir_output='/Users/giusyfedele/Dropbox (CMCC)/ADRIACLIM_xGiusy/periodi/indicatori_mensili/'  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for iregion=1:length(regions)
    ...
    for iperiod=1:length(periods)
        ...
        indicators=extremesIndicators_adriaclim(1,'M',tas,tasmin,tasmax,pr,[],[],[],wind10,[],[],tas_th,tasmin_th,tasmax_th,pr_th,period,date_th,vettindex(6));
        ...
        savefile=[dir_output,regions{iregion} '_ERA5_Land_monthly_' periods{iperiod} '_indicators.mat'];
        save(savefile,'indicators')

        % TO SAVE INDICATORS AS .nc
        filename_nc=strcat('Indicators_',num2str(regions{iregion}),'_',num2str(periods{iperiod}),'_monthly.nc');
