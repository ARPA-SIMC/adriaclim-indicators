...
%If you are working in Matlab please put "%" symbol in the following three lines:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
pkg load statistics
pkg load io
pkg load netcdf
...
dir_output='/Users/giusyfedele/Dropbox (CMCC)/ADRIACLIM_xGiusy/periodi/indicatori_stagionali/';  %To define the path where to locate the outputs
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for iregion=1:length(regions)
    ...
    for iperiod=1:length(periods)
        ...
        indicators=extremesIndicators_adriaclim(1,'S',tas,tasmin,tasmax,pr,[],[],[],wind10,[],[],tas_th,tasmin_th,tasmax_th,pr_th,period,date_th,vettindex);
        ...
        savefile=[dir_output,regions{iregion} '_ERA5_Land_seasonal_' periods{iperiod} '_indicators.mat'];
        %save(savefile,'indicators')
        
        save savefile indicators

        % TO SAVE INDICATORS AS .nc
        filename_nc=strcat('Indicators_',num2str(regions{iregion}),'_',num2str(periods{iperiod}),'_seasonal.nc');
